  ...
  return (
    <div className="min-h-screen bg-tea-cream-light flex items-center justify-center px-4">
      <div className="text-center max-w-md" role="status" aria-live="polite">
        ...
        <h2 className="font-serif text-2xl font-normal text-tea-text mb-3 tracking-display">{title}</h2>
    ...
    return (
      <div className="min-h-screen bg-tea-cream-light flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <h2 className="font-serif text-3xl font-normal text-tea-text mb-3 tracking-display">{t("paypalCancelTitle")}</h2>
    ...
    return (
      <div className="min-h-screen bg-tea-cream-light flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <h2 className="font-serif text-3xl font-normal text-tea-text mb-3 tracking-display">{t("paypalCaptureFailed")}</h2>
      ...
      <div className="text-center max-w-md">
        {isSuccess ? (
          <>
            ...
            {isBooking ? (
              <>
                <h2 className="font-serif text-3xl font-normal text-tea-text mb-3 tracking-display">{t("bookingSuccess")}</h2>
              ...
              <>
                <h2 className="font-serif text-3xl font-normal text-tea-text mb-3 tracking-display">{t("orderSuccess")}</h2>
          ...
          <>
            ...
            <h2 className="font-serif text-3xl font-normal text-tea-text mb-3 tracking-display">{t("paymentFailed")}</h2>
