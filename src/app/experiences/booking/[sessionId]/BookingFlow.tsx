    ...
    <div className="max-w-2xl mx-auto">
      ...
      {isFull && !waitlistDone && (
        <div className="bg-white rounded-2xl p-6 border border-tea-green-pale/50 shadow-sm">
          ...
          <h3 className="font-serif text-lg font-semibold text-tea-text mb-5">{t("waitlist.title")}</h3>

          {/* 候補人數 */}
          <div className="flex items-center gap-6 mb-5">
            <button onClick={() => setWaitlistCount(c => Math.max(1, c - 1))} disabled={waitlistCount <= 1}
              className="w-10 h-10 rounded-full border-2 border-tea-green text-tea-green-ink font-bold text-xl hover:bg-tea-green-dark hover:text-white transition-colors disabled:opacity-30">−</button>
      ...
      {isFull && waitlistDone && (
        <div className="bg-white rounded-2xl p-8 border border-tea-green-pale/50 shadow-sm text-center">
          ...
          <h3 className="font-serif text-xl font-semibold text-tea-text mb-2">{t("waitlist.successTitle")}</h3>
      ...
      {!isFull && step === 1 && (
        <div className="bg-white rounded-2xl p-6 border border-tea-green-pale/50 shadow-sm">
          <h3 className="font-serif text-lg font-semibold text-tea-text mb-6">{t("selectParticipants")}</h3>

          {/* 人數選擇器 */}
          <div className="flex items-center gap-6 mb-6">
            <button
              onClick={() => setCount(c => Math.max(1, c - 1))}
              className="w-10 h-10 rounded-full border-2 border-tea-green text-tea-green-ink font-bold text-xl hover:bg-tea-green-dark hover:text-white transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
              disabled={count <= 1}
            >
              −
            </button>
      ...
      {!isFull && step === 2 && (
        <div className="bg-white rounded-2xl p-6 border border-tea-green-pale/50 shadow-sm">
          ...
          <h3 className="font-serif text-lg font-semibold text-tea-text mb-6">{t("bookerInfo")}</h3>
