      ...
      <section className="relative min-h-[100svh] flex items-center overflow-hidden">
        {/* 背景不是輪播，是**交叉淡入**：文案與 CTA 完全不動，只換底圖。
            ...
            **每張配自己的遮罩，不共用**。實測（1440×900 裁切下，文字區對
            ...
            2026-08-26 wilting4 重裁：改從原檔 `20260427_103350` 取
            `left0 top1000 3200x2000`，輸出 2560x1600（1.28MB）。切掉的是頂部
            那條深色遮陽網與右側停車棚——網子會跟公告條、sticky header 疊成三層
            深色壓在頂端，而白色轎車正好落在遮罩最淡（20%）、露最多的右側。
            2560x1600 是 16:10，桌機 1440×900 幾乎不再二次裁切。

            **遮罩不能拿掉**（2026-08-26 實測，量測框與上表不同，只能組內比）：
              新裁切 @0%  最差5% 1.18 / 單點 1.00　← 文字直接消失
              新裁切 @40% 最差5% 2.28
              新裁切 @65% 最差5% 3.76　← 與舊裁切 3.75 等值，維持 65%
              手機（均勻遮罩）@0% 最差5% 1.16、@65% 3.75
