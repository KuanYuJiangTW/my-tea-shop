...
export default function CheckoutClient() {
  ...
  const inputCls = (hasError?: boolean) =>
    `w-full border rounded-control px-4 py-3 text-label text-tea-text placeholder-tea-text-light/60 focus:outline-none focus:border-tea-green bg-tea-cream/50 ${
              ...
              <div className="bg-white rounded-card p-7 shadow-resting">
                ...
                <div className="space-y-3">
                  {([
                    ...
                    <label key={opt.value} className={`flex items-start gap-4 p-4 rounded-control border transition-colors ${opt.disabled ? "cursor-not-allowed opacity-50 border-tea-green-pale bg-tea-cream-dark/40" : `cursor-pointer ${payment === opt.value ? "border-tea-green bg-tea-green-mist" : "border-tea-green-pale hover:bg-tea-cream"}`}`}>
              ...
              <div className="bg-white rounded-card p-7 shadow-resting">
                ...
                <div className="mb-5">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {([
                      ...
                      <label key={opt.value} className={`flex flex-col items-center gap-1.5 p-3 rounded-control border cursor-pointer transition-colors text-center ${region === opt.value ? "border-tea-green bg-tea-green-mist" : "border-tea-green-pale hover:bg-tea-cream"}`}>
                ...
                <div className="space-y-3 mb-6">
                  {([
                    ...
                    <label key={opt.value} className={`flex items-start gap-4 p-4 rounded-control border cursor-pointer transition-colors ${delivery === opt.value ? "border-tea-green bg-tea-green-mist" : "border-tea-green-pale hover:bg-tea-cream"}`}>
                ...
                {region === "international" && (
                  <div className="space-y-4 mb-6">
                    ...
                    {selectedCountry && !isOverweight && (
                      <div className="flex flex-col gap-1 bg-tea-cream/80 rounded-control p-3">
                  ...
                  <div className="relative">
                    <div className="flex gap-1.5">
                      <input
                        ...
                        className="flex-1 border border-tea-green-pale rounded-inline px-3 py-2 text-caption focus:outline-none focus:border-tea-green bg-tea-cream/50 font-mono"
                      />
                      {availableCoupons.length > 0 && (
                        <button type="button" onClick={() => setShowCouponDropdown(v => !v)}
                          className="px-2.5 border border-tea-green-pale rounded-inline hover:bg-tea-cream transition-colors text-tea-text-light"
                          title={t("coupon")}>
                          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                            <path d="M6 9l6 6 6-6"/>
                          </svg>
