      ...
      <section className="bg-tea-cream py-16 md:py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-tea-cream-dark/30 p-8 md:p-10">
            <div className="flex items-center gap-3 mb-5">
              <div className="w-8 h-8 rounded-full bg-tea-green/20 flex items-center justify-center flex-shrink-0">
                <span className="text-tea-green-ink font-bold text-sm">1</span>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-tea-cream-dark/30 p-8 md:p-10">
            <div className="flex items-center gap-3 mb-5">
              <div className="w-8 h-8 rounded-full bg-tea-green/20 flex items-center justify-center flex-shrink-0">
                <span className="text-tea-green-ink font-bold text-sm">2</span>
              </div>
              ...
              {STEP_KEYS.map((key, i) => (
                <li key={key} className="flex gap-4">
                  <div className="flex-shrink-0 w-6 h-6 rounded-full bg-tea-green/15 flex items-center justify-center mt-0.5">
                    <span className="text-xs font-bold text-tea-green-ink">{i + 1}</span>
                  </div>
                  <div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-tea-cream-dark/30 p-8 md:p-10">
            <div className="flex items-center gap-3 mb-5">
              <div className="w-8 h-8 rounded-full bg-tea-green/20 flex items-center justify-center flex-shrink-0">
                <span className="text-tea-green-ink font-bold text-sm">3</span>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-tea-cream-dark/30 p-8 md:p-10">
            <div className="flex items-center gap-3 mb-5">
              <div className="w-8 h-8 rounded-full bg-tea-green/20 flex items-center justify-center flex-shrink-0">
                <span className="text-tea-green-ink font-bold text-sm">4</span>
              </div>
          ...
          <div className="bg-tea-text rounded-2xl p-8 md:p-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="tel:0972619391"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-tea-green-ink text-white rounded-full text-sm font-medium hover:bg-tea-green-ink/90 transition-colors"
              >
