    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="flex flex-wrap gap-4 justify-center mt-14">
          <Link
            href={lp("/products")}
            className="bg-tea-green-ink hover:bg-tea-green-deep text-white px-8 py-3.5 rounded-full font-medium transition-colors shadow-sm"
          >
            {c.ctaProducts}
          </Link>
          <Link
            href={lp("/experiences")}
            className="border-2 border-tea-green text-tea-green-ink hover:bg-tea-green-ink hover:text-white px-8 py-3.5 rounded-full font-medium transition-colors"
          >
            {c.ctaExperiences}
          </Link>
        </div>
