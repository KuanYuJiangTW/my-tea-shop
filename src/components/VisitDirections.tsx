...
import {
  DRIVE_TIMES, ROAD_NOTE, ROAD_NOTE_EN, STREET_ADDRESS, STREET_ADDRESS_EN,
 ...
 */
export default async function VisitDirections() {
      ...
      >
        ...
        <span className="min-w-0">
          <span className="block text-label font-medium">
            {t("navigateTo", { place: isEn ? d.nameEn : d.name })}
          </span>
  ...
  return (
    <section className="rounded-2xl border border-tea-green-pale bg-tea-cream/60 p-5 md:p-6">
      ...
      <p className="text-body text-tea-text-muted mb-4">{t("intro")}</p>
