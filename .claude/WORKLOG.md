...
- **萬鷺朝鳳生態解說手冊待業主校稿→送印**（2026-09-24 做好，分支 `docs/egret-handbook`，未開 PR）：`docs/egret-handbook/`，A5 16 頁、20 筆出處已查證、copy-guardian 7 項 PASS。改稿規則、刻意不寫的事、每年要換的東西都在該資料夾 README。**導覽已經在賣「手冊一份」，本季還剩到 10/11。**
- **攻略文「有沒有留鳥還待研究」已過時**：《2026 年臺灣鳥類名錄》列黃頭鷺為留鳥（不普遍）＋夏候＋冬候＋過境（名錄第 300 號 `RU/SC/WC/TC`）。要不要改 Sanity 攻略文由業主決定（改了直接上線）。
