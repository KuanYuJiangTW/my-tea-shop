  ...
  theme: {
    extend: {
      colors: {
        ...
        //
        // 彩度刻意壓在樣本中位數附近而非上限：cta-tea C.099（Loro Piana .102／Aesop .100 之間）、
        // cta-visit C.045（正好是小江偏好的莫蘭迪上限，且明度 .388 幾乎等於 tea-text 的 .395，
        // 兩個深色同重量、一暖一冷互相撐住）。
        cta: {
          tea: "#9A5340",   "tea-dark": "#7A4F3F",   "tea-soft": "#F3E9E4",   // 焙火紅：白字 5.70／6.96；淡底配茶墨字 7.79
          visit: "#33465C", "visit-dark": "#2F4157", "visit-soft": "#E8EDF1", // 山嵐紺：白字 9.67／10.42；淡底配茶墨字 7.89
        },
