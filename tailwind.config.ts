  ...
  theme: {
    extend: {
      colors: {
        ...
        // 2026-09-04 刪掉 `cta-tea-soft`／`cta-visit-soft` 兩個淡底變體。
        // 它們是為季節條帶做的，那個方案被業主否決（冷色留在重音、不進底色，
        // 見 design-system 2.1.1 末），之後兩個月無人取用——孤兒 token 會讓
        // 後來的人以為「這裡本來就該有淡底可選」而誤用。要淡底就走 tea-cream 序列。
        // 當初訂它們明度時學到的通則已收進 design-system 2.1.5：
        // **挑區塊底色要對照那個區塊裡最淡的文字色，不是最深的。**
        cta: {
          tea: "#B34D31",   "tea-dark": "#973317",   // 焙火紅：白字 5.22／7.50
          visit: "#2A4073", "visit-dark": "#1E2E53", // 紺：白字 10.10／13.37
        },
